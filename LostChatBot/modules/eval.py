...
async def executor(client: VenomBot, message: Message):
    if len(message.command) < 2:
        return await edit_or_reply(message, text="☞ Could you please specify the task you would like me to execute? ")
    try:
