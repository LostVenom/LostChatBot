...
from LostChatBot.modules.helpers import CHATBOT_ON, is_admins


@VenomBot.on_cmd("chatbot", group_only=True)
@adminsOnly("can_delete_messages")
async def chaton_(_, m: Message):
    await m.reply_text(
        f"☞ Choose an Option to Enable/Disable Chatbot in {m.chat.title} !",
